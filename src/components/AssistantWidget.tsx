...
export default function AssistantWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed inset-0 z-50 flex items-end justify-center md:items-stretch md:justify-end p-0 bg-black/30 md:bg-black/10"
          onClick={() => setOpen(false)}
        >
          <div
            className="menu-pop w-full md:w-[440px] h-[85vh] md:h-auto max-h-[85vh] md:max-h-none bg-white rounded-t-[20px] md:rounded-none md:border-l md:border-border shadow-[0_12px_40px_rgba(16,42,58,0.25)] md:shadow-[-8px_0_32px_rgba(16,42,58,0.14)] flex flex-col overflow-hidden"
            style={{ transformOrigin: "bottom right" }}
            onClick={(e) => e.stopPropagation()}
          >
            <div
              className="flex items-center gap-2.5 px-4 py-3.5 md:px-5 md:py-4 shrink-0"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                  <span className="text-[13px] md:text-sm font-bold text-white">LIMS Assistant</span>
                ...
                <div className="text-[10px] md:text-[11px] text-white/75 truncate">Samples, stok, kalibrasi, analytics</div>
              </div>
