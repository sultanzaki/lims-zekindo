...
const ACTION_INFO: Record<string, { label: string; category: AuditCategory }> = {
  ...
  "catalog.business_unit_created": { label: "Business unit added", category: "create" },
  "catalog.business_unit_activated": { label: "Business unit activated", category: "approve" },
  "catalog.business_unit_deactivated": { label: "Business unit deactivated", category: "remove" },
  ...
  "equipment.calibration_logged": { label: "Equipment calibration logged", category: "update" },
  "equipment.maintenance_logged": { label: "Equipment maintenance logged", category: "update" },
  ...
  "reagent.stock_received": { label: "Reagent stock received", category: "create" },
  "reagent.stock_consumed": { label: "Reagent stock consumed", category: "update" },
  "reagent.stock_adjusted": { label: "Reagent stock adjusted", category: "update" },
  "reagent.stock_disposed": { label: "Reagent stock disposed", category: "remove" },
